          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="inline-flex rounded-xl border border-[var(--border)] bg-[var(--surface-elevated)] p-1">
              <button
                ...
                className={`flex-1 rounded-lg py-1 text-center text-xs font-medium transition ${
                  statusFilter === "all" ? "bg-[var(--surface)] text-white shadow-sm font-semibold" : "text-[var(--text-muted)] hover:text-white"
                }`}
              >
                All
              </button>
              <button
                ...
                className={`flex-1 rounded-lg py-1 text-center text-xs font-medium transition ${
                  statusFilter === "present" ? "bg-emerald-500/20 text-emerald-300 font-semibold" : "text-[var(--text-muted)] hover:text-white"
                }`}
              >
                Present
              </button>
              <button
                ...
                className={`flex-1 rounded-lg py-1 text-center text-xs font-medium transition ${
                  statusFilter === "absent" ? "bg-red-500/20 text-red-300 font-semibold" : "text-[var(--text-muted)] hover:text-white"
                }`}
              >
                Absent
              </button>
            ...
            <div className="inline-flex rounded-xl border border-[var(--border)] bg-[var(--surface-elevated)] p-1">
              <button
                ...
                className={`flex-1 rounded-lg py-1 text-center text-xs font-medium transition ${
                  timeframeFilter === "all" ? "bg-[var(--surface)] text-white shadow-sm font-semibold" : "text-[var(--text-muted)] hover:text-white"
                }`}
              >
                All Time
              </button>
              <button
                ...
                className={`flex-1 rounded-lg py-1 text-center text-xs font-medium transition ${
                  timeframeFilter === "month" ? "bg-[var(--surface)] text-white shadow-sm font-semibold" : "text-[var(--text-muted)] hover:text-white"
                }`}
              >
                30 Days
              </button>
              <button
                ...
                className={`flex-1 rounded-lg py-1 text-center text-xs font-medium transition ${
                  timeframeFilter === "week" ? "bg-[var(--surface)] text-white shadow-sm font-semibold" : "text-[var(--text-muted)] hover:text-white"
                }`}
              >
                7 Days
              </button>
