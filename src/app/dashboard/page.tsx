...
export default function DashboardPage() {
  ...
  useEffect(() => onAuthStateChanged(firebaseAuth, async (user) => {
    ...
    try {
      ...
      setMessage(error instanceof Error ? error.message : "Unable to load your workspace.");
    } finally {
      setLoading(false);
    }
  }), [router]);
